...
WHERE transaction_credit.Enrolee = %s AND transaction_credit.Status = 1 AND      
...
FROM newmed06.transaction_credit     
INNER JOIN newmed06.transation_credit_detail          
ON (transaction_credit.Detail = transation_credit_detail.Id)      WHERE transaction_credit.Enrolee = %s AND      transaction_credit.Visit = %s AND transation_credit_detail.Group = 1 AND transaction_credit.Status = 1", GetSQLValueString($colname_pays2, "int"),GetSQLValueString($colname2_pays2, "date"));
...
INNER JOIN newmed06.transation_credit_detail          
ON (transaction_credit.Detail = transation_credit_detail.Id)     
WHERE transaction_credit.Enrolee = %s AND transaction_credit.Status = 1 AND      transaction_credit.Visit = %s AND transation_credit_detail.Group = 1", GetSQLValueString($colname_pays21, "int"),GetSQLValueString($colname2_pays21, "date"));

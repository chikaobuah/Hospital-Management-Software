...
$query_visit_pro = sprintf("SELECT COUNT(Visit) as count FROM
    ...
    INNER JOIN newmed06.visit_procedure 
        ON (visit_procedure.Procedure = procedure.Id) WHERE Enrolee = %s AND visit_procedure.Visit = '$colname3_visit_pro2'", GetSQLValueString($colname_visit_pro, "int"));
...
$query_visit_pro2 = sprintf("SELECT COUNT(Visit) as count FROM
    ...
    INNER JOIN newmed06.task 
        ON (service.Task_FK = task.Id)
    INNER JOIN newmed06.visit_procedure 
        ON (visit_procedure.Procedure = procedure.Id) WHERE Enrolee = %s AND visit_procedure.Visit = '$colname3_visit_pro2' AND service.Task_FK = 25", GetSQLValueString($colname_visit_pro2, "int"));
...
$query_blood = sprintf("SELECT COUNT(Visit) as count FROM
    ...
    INNER JOIN newmed06.visit_prescription 
        ON (visit_prescription.Drug_FK = drug.Id) WHERE Enrolee = %s AND service.Task_FK = 24 AND visit_prescription.Visit = '$colname_blood2' ", GetSQLValueString($colname_blood, "int"));
...
$query_drug = sprintf("SELECT COUNT(Visit) as count FROM
    ...
    INNER JOIN newmed06.task 
        ON (service.Task_FK = task.Id)
    INNER JOIN newmed06.visit_prescription  
        ON (visit_prescription.Drug_FK = drug.Id) WHERE Enrolee = %s AND service.Blocks = 16 AND visit_prescription.Visit = '$colname_blood2' ", GetSQLValueString($colname_drug, "int"));
...
$query_injection = sprintf("SELECT COUNT(Visit) as count FROM
    ...
    INNER JOIN newmed06.task 
        ON (service.Task_FK = task.Id)
    INNER JOIN newmed06.visit_prescription  
        ON (visit_prescription.Drug_FK = drug.Id) WHERE Enrolee = %s AND service.Task_FK = 16 AND visit_prescription.Visit = '$colname_blood2'", GetSQLValueString($colname_injection, "int"));
 ...
 if($count5 > 0)
{
	...
	echo "<tr>
		  ...
		  <td align=\"left\"> <a href=\"javascript:listt2('$Principal','$Enrolee', '$Scheme', '$Capitation', '$lc', '$lc2', '$status', '$VisitID', '$VisitID2','showlist','viewallergy.php');\"> Allergy</a></td><tr> "; }?>
 ...
 if($count > 0)
{
	...
	echo "<tr>
		  ...
		  <td align=\"left\">
   <a class=\"normal\" href=\"javascript:listt2('$Principal','$Enrolee', '$Scheme', '$Capitation', '$lc', '$lc2', '$status', '$VisitID', '$VisitID2','showlist','bills.php');\">Bill</a></td></tr>";
	
	}?>
    
	  <?php	echo "  <td align=\"left\">
 <a class=\"normal\" href=\"javascript:listt2('$Principal','$Enrolee', '$Scheme', '$Capitation', '$lc', '$lc2', '$status', '$VisitID', '$VisitID2','showlist','alert.php');\">Birthdays</a></td><tr>";?>
 ...
 if($count7 > 0)
{
	...
	echo "<tr>
		  ...
		  <td align=\"left\">
   <a class=\"normal\" href=\"javascript:listt2('$Principal','$Enrolee', '$Scheme', '$Capitation', '$lc', '$lc2', '$status', '$VisitID', '$VisitID2','showlist','blood.php');\">Blood</a></td></tr>";
 ...
 if($count8 > 0)
{
	...
	echo "<tr>
		  ...
		  <td align=\"left\">
   <a class=\"normal\" href=\"javascript:listt2('$Principal','$Enrolee', '$Scheme', '$Capitation', '$lc', '$lc2', '$status', '$VisitID', '$VisitID2','showlist','dispenary.php');\">Precription</a></td></tr>";
  ...
  if($count4 > 0)
{
	...
	echo "<tr align=\"left\" >
    <td align=\"left\"><a class=\"normal\" href=\"javascript:listt2('$Principal','$Enrolee', '$Scheme', '$Capitation', '$lc', '$lc2', '$status', '$VisitID', '$VisitID2','showlist','viewhealth.php');\">Family Health</a></td>
	</tr>";
	}?>
  ...
  if($count3 > 0)
{
	...
	echo "<tr align=\"left\" >
    <td align=\"left\"><a class=\"normal\" href=\"javascript:listt2('$Principal','$Enrolee', '$Scheme', '$Capitation', '$lc', '$lc2', '$status', '$VisitID', '$VisitID2','showlist','lablist.php');\">Procedures</a></td>
  </tr>";
...
{
	echo "<tr align=\"left\" >
    <td align=\"left\"><a class=\"normal\" href=\"javascript:listt2('$Principal','$Enrolee', '$Scheme', '$Capitation', '$lc', '$lc2', '$status', '$VisitID', '$VisitID2','showlist','lablist.php');\">Procedures</td></a>
  </tr>";

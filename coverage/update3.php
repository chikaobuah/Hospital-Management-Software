...
$query_cover2 = "SELECT * FROM cover_drug WHERE Drug_FK = $cover AND Effective = $ef AND Capitation = $li AND License = $license";
...
if ($status == 2)
{
	$query = "UPDATE cover_drug SET Status ='$che' WHERE Id ='$cov'";

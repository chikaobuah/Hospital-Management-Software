...
$sql2="INSERT INTO user (Licensee_Hqs,LId,User_Id,User_Password,User_Name,Status)VALUES('$lcnhq','$lid','$userid','$userpw','$usern','$status')";
...
$URL="vendoruser.php?id=$lcn&lcnhq=$lcnhq";

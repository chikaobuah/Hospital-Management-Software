...
do {
 ...
 if($numrows!=0) 
{
echo "<a  class=\"linkr\" onClick=\"getData('ticket.php?id=$ID','dataplan1st.php?id=$ID','picture.php?id=$ID', 'vitalsforenr.php?id=$ID&vi=$Visit','billboard1st.php?id=$ID')\">" .$Full_Name ." "."(".$age.")"."</a>\n";
...
?>
    ...
    <td width="68%" valign="top" ><table width="100%" height="431" border="0">
      <tr>
        <td height="121" valign="top"><table bgcolor="#FFF5D9" align="left"width="100%" height="115" border="0">
...
<table width="100%" height="100%" border="0">
      ...
      <tr>
        <td valign="top"><table width="100%" height="290" border="0">
          <tr>
            <td width="21%" height="284"  valign="top" style="">
            <table bgcolor="#DDFFDD"    width="100%" height="300" border="0" >
                 <tr>
                   <th bgcolor="#999999" height="22px" width="18%" scope="col">Bill Board </th>
                 </tr>
                 <tr>
                   <td  bgcolor="#f2f2f2" height="45%"  valign="top" > <div id="billboard" align="left"> </div>  </td>
                 </tr>
                 </table>
                 </td>

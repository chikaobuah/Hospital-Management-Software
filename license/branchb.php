...
width=\"16\" height=\"16\" 
onClick=\"getData('branchf.php?licenhq=$licenhq&num=$num&lcount=$lcount')\"/>"; }?>       <img style="float:left"; src="../images/icons/min - Copy.gif" width="16" height="16" />
                <?php        echo "<img style=\"float:left\"; src=\"../images/icons/error.png\"  width=\"16\" height=\"16\" onClick=\"getData('new1.php?licenhq=$licenhq&webpage=$webpage&CAC_reg_no=$CAC_reg_no&Statement=$Statement&NHMIS_HF_Code=$NHMIS_HF_Code  ')\"/>";?>
    ...
    <div id="d1">
      <table  class="sample">
        ...
        <tr class="tablebody">
          <td><label  style="display:inline-block; width:150px; " >NHIS No.\ Date</label><input type="text" name="textfield3" id="textfield3"  value="<?php   echo $nhisno[$num]; ?>"  style="width:19%;  height:100%;"/><input type="text" value="<?php   echo $short[$num]; ?>"name="textfield3" id="textfield3" style="width:19%;  height:100%;"  />

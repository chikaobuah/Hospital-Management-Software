...
//if prn is not a principal n is not equal to dep do d following
if (($ticketc<1) && ($dep!=$prn))
{
...
$sql4="INSERT INTO enrolee_principal (Enrolee,Principal,Status)VALUES('$dep','$prn',$st)";
...
$sql5="INSERT INTO enrolee_principal (Enrolee,Principal,Status)VALUES('$dep','$prn',$st)";

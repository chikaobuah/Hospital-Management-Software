...
width=\"16\" height=\"16\" 
onClick=\"getData('branchf.php?clhq=$clhq&num=$num&lcount=$lcount')\"/>"; 
...
<?php        echo "<img style=\"float:left\"; src=\"../images/icons/error.png\"  width=\"16\" height=\"16\" onClick=\"getData('new1.php?clhq=$clhq[0]&webpage=$webpage[0]&CAC_reg_no=$CAC_reg_no[0]&Statement=$Statement[0]&NHMIS_HF_Code=$NHMIS_HF_Code[0]  ')\"/>";?>
</div>

...
FROM
    newmed06.licensee
    left JOIN newmed06.licensee_hqs 
...
?>
    ...
    <table  class="sample">
        ...
        <tr class="tablebody">
          <td><label  style="display:inline-block; width:150px; " >License Date</label><input type="text"  disabled="disabled" name="ldate" id="ldate" style="height:100%; " />
...
?>
    ...
    <div id="d5"><table  class="sample">
        ...
        <tr class="tablebody">
          <td><label  style="display:inline-block; width:150px;">Webpage</label><input type="text"  id="web" disabled="disabled" name="web"  value="<?php   echo $webpage; ?>"  style="height:100%;"/>
          </td>
        </tr>
        <tr class="tablebody">
          <td><label  style="display:inline-block; width:150px; " >CAC Reg No.</label><input type="text"   disabled="disabled"name="cac" id="cac" style="height:100%;" value="<?php   echo $CAC_reg_no; ?>"/></td>
        </tr>
        <tr class="tablebody">
          <td><label  style="display:inline-block; width:150px; " >Ownership</label><select name="owner"  disabled="disabled"id="owner" style="height:100%; width:157px;"> </select></td>
        </tr>
        <tr class="tablebody">
          <td><label  style="display:inline-block; width:150px; " >NHMIS HF Code</label><input  disabled="disabled"type="text" name="nhmis" id="nhmis" style="height:100%;"  value="<?php   echo $NHMIS_HF_Code; ?>" /></td>
        </tr>
    </table></div>
      ...
      </table><input  name="" type="button" value="Add" style="background:url(../images/nav-bg.png)" onclick="addlicense('addlicense.php')"/></div>
...
echo  "<input type=\"hidden\" name=\"created\" id=\"created\" value=\"". $date." \"   />"; 

echo  "<input type=\"hidden\" name=\"webpage\" id=\"webpage\" value=\"". $webpage." \"   />";
echo  "<input type=\"hidden\" name=\"CAC_reg_no\" id=\"CAC_reg_no\" value=\"". $CAC_reg_no." \"   />";
echo  "<input type=\"hidden\" name=\"Statement\" id=\"Statement\" value=\"". $Statement." \"   />";
echo  "<input type=\"hidden\" name=\"NHMIS_HF_Code\" id=\"creator\" value=\"". $NHMIS_HF_Code." \"   />";

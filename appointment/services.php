...
$query_services = "SELECT * FROM service WHERE Direction = 1 AND Blocks = 2 ORDER BY Service";
...
<table width="100%" align="left" bgcolor="#e5e5e5" style="border:thin; border-color:#000; border-collapse:collapse;">
  ...
  <?php do { ?>
   ...
   <?php 
      ...
      <td align="left" class="tablebody"><?php echo "<a href=\"javascript:first('$row_services[Id]');\">";?><?php echo $row_services['Service']; ?></a></td>
    </tr>

...
FROM
    ...
    LEFT JOIN newmed06.client 
        ON (scheme.Company_FK = client.LId) WHERE enrolee =$ID ORDER BY Scheme LIMIT 1 ";
...
<table width="100%" height="100" border="0">
  <tr>
    <td height="26" style="background:#999" align="center"><strong><?php echo $fn;?></strong></td>
  </tr>
  <tr>
    <td valign="top">
    		<table width="100%" border="0" height="70">
		         <tr>
                   ...
                   <td width="71%" bgcolor="#F0F5F9"><?php   echo strtolower($principal); ?></td>
                 </tr>
                 <tr>
                   <td  bgcolor="#C7DEE9"height="25"><?php   echo $Program; ?></td>
                   <td bgcolor="#F0F5F9" ><?php echo $Short ." ". $Contact." ". $Contact_Mobile_Phone; ?></td>
                 </tr>
               </table>
     </td>
  </tr>

...
echo   "<tr><td><a class=\"linkr\" onClick=\"getcounter('countermsg.php?x=1&id=$ID&fn=$fn')\"> Consulting</a></td></tr>"; 


echo   "<tr><td><a class=\"linkr\" onClick=\"getcounter('countermsg.php?x=2&id=$ID&fn=$fn')\">Vitals</a></td></tr>"; 


echo   "<tr><td><a class=\"linkr\" onClick=\"getcounter('countermsg.php?x=3&id=$ID&fn=$fn')\">Other Services</a></td></tr>"; 


echo   "<tr><td><a class=\"linkr\"  onClick=\"getcounter('countermsg.php?x=4&id=$ID&fn=$fn')\">Payment</a></td></tr>";


echo   "<tr><td><a class=\"linkr\"  onClick=\"getcounter('countermsg.php?x=5&id=$ID&fn=$fn')\">Emergency</a></td></tr>";

if ($blood>0)
{echo   "<tr><td><a class=\"linkr\"  onClick=\"getcounter('countermsg.php?x=6&id=$ID&fn=$fn')\">$blooda</a></td></tr>"; }


if ($druga>0)
{echo   "<tr><td><a class=\"linkr\" onClick=\"getcounter('countermsg.php?x=7&id=$ID&fn=$fn')\">$drugb</a></td></tr>"; }



if ($injectiona>0)
{echo   "<tr><td><a class=\"linkr\" onClick=\"getcounter('countermsg.php?x=8&id=$ID&fn=$fn')\">$injectionb</a></td></tr>"; }



if ($dressinga>0)
{echo   "<tr><td><a class=\"linkr\" onClick=\"getcounter('countermsg.php?x=9&id=$ID&fn=$fn')\">$dressingb</a></td></tr>"; }



if ($laba>0)
{echo   "<tr><td><a class=\"linkr\"  onClick=\"getcounter('countermsg.php?x=10&id=$ID&fn=$fn')\">$labb</a></td></tr>"; }
